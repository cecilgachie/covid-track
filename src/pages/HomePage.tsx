  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col" data-id="at274u92h" data-path="src/pages/HomePage.tsx">
      ...
      <main className="flex-1" data-id="ivhfmfp70" data-path="src/pages/HomePage.tsx">
        {/* Hero Section */}
        <section className="py-20 px-6 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100" data-id="59nptemhd" data-path="src/pages/HomePage.tsx">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center" data-id="a4zra2ysm" data-path="src/pages/HomePage.tsx">
              <div className="space-y-6" data-id="u3f0wmo0s" data-path="src/pages/HomePage.tsx">
                ...
                <div className="flex flex-wrap gap-4" data-id="2s5sfsad0" data-path="src/pages/HomePage.tsx">
                  ...
                  <Link to="/about">
                    <Button size="lg" variant="outline" className="border-gray-400 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-800">
                      {t('learnMore')}
                    </Button>
                  </Link>
                </div>
        ...
        {/* Features Section */}
        <section className="py-16 px-6 bg-white dark:bg-gray-900" data-id="o17bbqoy8" data-path="src/pages/HomePage.tsx">
          <div className="container mx-auto max-w-6xl" data-id="pl9evpumy" data-path="src/pages/HomePage.tsx">
            ...
            <div className="grid md:grid-cols-3 gap-8" data-id="ahwunoncw" data-path="src/pages/HomePage.tsx">
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg" data-id="ep9lbpvcc" data-path="src/pages/HomePage.tsx">
                <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded-full flex items-center justify-center mb-4" data-id="b0sa9zp8k" data-path="src/pages/HomePage.tsx">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg" data-id="l4qiwzre6" data-path="src/pages/HomePage.tsx">
                <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded-full flex items-center justify-center mb-4" data-id="1asr3mz5n" data-path="src/pages/HomePage.tsx">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg" data-id="6nzks1bkp" data-path="src/pages/HomePage.tsx">
                <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded-full flex items-center justify-center mb-4" data-id="m7fj5kfgm" data-path="src/pages/HomePage.tsx">
        ...
        {/* Stats Section */}
        <section className="py-16 px-6 bg-gray-50 dark:bg-gray-900" data-id="bg3gwwsg3" data-path="src/pages/HomePage.tsx">
      ...
      <footer className="border-t py-8 bg-white dark:bg-gray-900 dark:border-gray-800" data-id="gzpuxzoms" data-path="src/pages/HomePage.tsx">
        <div className="container mx-auto px-6" data-id="i0klnkt5x" data-path="src/pages/HomePage.tsx">
          ...
          <div className="mt-6 text-center text-gray-400 dark:text-gray-500 text-sm" data-id="pvkyyr11a" data-path="src/pages/HomePage.tsx">
            <p data-id="yzsjmzw0z" data-path="src/pages/HomePage.tsx">© {new Date().getFullYear()} Covid-Track. {t('allRightsReserved')}</p>
          </div>
        </div>
      </footer>
    </div>);
